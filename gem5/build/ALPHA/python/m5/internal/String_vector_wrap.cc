...
#define SWIGTYPE_std__string swig_types[12]
...
/*-----------------------------------------------
              @(target):= _String_vector.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__String_vector

#else
#  define SWIG_init    init_String_vector

#endif
#define SWIG_name    "_String_vector"

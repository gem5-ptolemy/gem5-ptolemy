...
import m5.internal.param_MemoryControl
...
class RubyMemoryControl(m5.internal.param_MemoryControl.MemoryControl):
...
class RubyMemoryControlParams(m5.internal.param_MemoryControl.MemoryControlParams):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    ...
    version = _swig_property(_param_RubyMemoryControl.RubyMemoryControlParams_version_get, _param_RubyMemoryControl.RubyMemoryControlParams_version_set)

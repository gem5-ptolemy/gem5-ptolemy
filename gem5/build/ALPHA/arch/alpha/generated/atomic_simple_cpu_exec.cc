...
namespace AlphaISAInst {
    ...
    Fault
    Nop::execute(AtomicSimpleCPU *, Trace::InstRecord *) const
    {
        return NoFault;
    }
    ...
    inline Fault checkFpEnableFault(AtomicSimpleCPU *xc)
    {
    ...
    Fault
    OpcdecFault::execute(AtomicSimpleCPU *xc,
    ...
    Fault
    FailUnimplemented::execute(AtomicSimpleCPU *xc,
                               Trace::InstRecord *traceData) const
    {
    ...
    Fault
    WarnUnimplemented::execute(AtomicSimpleCPU *xc,
                               Trace::InstRecord *traceData) const
    {
        if (!warned) {
    ...
    Fault
    Unknown::execute(AtomicSimpleCPU *xc,
                     Trace::InstRecord *traceData) const
    {
...
// LoadAddress::lda([' Ra = Rb + disp; '],{})
    ...
    Fault Lda::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// LoadAddress::ldah([' Ra = Rb + (disp << 16); '],{})
    ...
    Fault Ldah::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// LoadOrNop::ldbu([' Ra_uq = Mem_ub; '],{})
    ...
    Fault Ldbu::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Ldbu::eaComp(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Ldbu::initiateAcc(AtomicSimpleCPU *xc,
                                      Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
// LoadOrNop::ldwu([' Ra_uq = Mem_uw; '],{})
    ...
    Fault Ldwu::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Ldwu::eaComp(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Ldwu::initiateAcc(AtomicSimpleCPU *xc,
                                      Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
// LoadOrNop::ldq_u([' Ra = Mem_uq; '],{'ea_code': ' EA = (Rb + disp) & ~7; '})
    ...
    Fault Ldq_u::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Ldq_u::eaComp(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Ldq_u::initiateAcc(AtomicSimpleCPU *xc,
                                      Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
// LoadOrNop::ldt([' Fa = Mem_df; '],{})
    ...
    Fault Ldt::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Ldt::eaComp(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Ldt::initiateAcc(AtomicSimpleCPU *xc,
                                      Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Ldl_l::eaComp(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Ldl_l::initiateAcc(AtomicSimpleCPU *xc,
                                      Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
// LoadOrNop::ldq_l([' Ra_uq = Mem_uq; '],{'mem_flags': 'LLSC'})
    ...
    Fault Ldq_l::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Ldq_l::eaComp(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Ldq_l::initiateAcc(AtomicSimpleCPU *xc,
                                      Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
// LoadOrPrefetch::ldl([' Ra_sl = Mem_sl; '],{})
    ...
    Fault Ldl::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Ldl::eaComp(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Ldl::initiateAcc(AtomicSimpleCPU *xc,
                                      Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault LdlPrefetch::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA M5_VAR_USED;
        Fault fault = NoFault;
...
;
    ...
    Fault LdlPrefetch::eaComp(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault LdlPrefetch::initiateAcc(AtomicSimpleCPU *xc,
                                      Trace::InstRecord *traceData) const
    {
...
// LoadOrPrefetch::ldq([' Ra_uq = Mem_uq; '],{'pf_flags': 'EVICT_NEXT'})
    ...
    Fault Ldq::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Ldq::eaComp(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Ldq::initiateAcc(AtomicSimpleCPU *xc,
                                      Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault LdqPrefetch::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA M5_VAR_USED;
        Fault fault = NoFault;
...
;
    ...
    Fault LdqPrefetch::eaComp(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault LdqPrefetch::initiateAcc(AtomicSimpleCPU *xc,
                                      Trace::InstRecord *traceData) const
    {
        warn("initiateAcc undefined: Misc instruction does not support split "
             "access method!");
...
// LoadOrPrefetch::lds([' Fa_uq = s_to_t(Mem_ul); '],{'pf_flags': 'PF_EXCLUSIVE', 'inst_flags': 'IsFloating'})
    ...
    Fault Lds::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Lds::eaComp(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Lds::initiateAcc(AtomicSimpleCPU *xc,
                                      Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault LdsPrefetch::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA M5_VAR_USED;
        Fault fault = NoFault;
...
;
    ...
    Fault LdsPrefetch::eaComp(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault LdsPrefetch::initiateAcc(AtomicSimpleCPU *xc,
                                      Trace::InstRecord *traceData) const
    {
        warn("initiateAcc undefined: Misc instruction does not support split "
             "access method!");
...
// Store::stb([' Mem_ub = Ra<7:0>; '],{})
    ...
    Fault Stb::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Stb::eaComp(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Stb::initiateAcc(AtomicSimpleCPU *xc,
                                      Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
// Store::stw([' Mem_uw = Ra<15:0>; '],{})
    ...
    Fault Stw::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Stw::eaComp(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Stw::initiateAcc(AtomicSimpleCPU *xc,
                                      Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
// Store::stl([' Mem_ul = Ra<31:0>; '],{})
    ...
    Fault Stl::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Stl::eaComp(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Stl::initiateAcc(AtomicSimpleCPU *xc,
                                      Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
// Store::stq([' Mem_uq = Ra_uq; '],{})
    ...
    Fault Stq::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Stq::eaComp(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Stq::initiateAcc(AtomicSimpleCPU *xc,
                                      Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
// Store::stq_u([' Mem_uq = Ra_uq; ', ' EA = (Rb + disp) & ~7; '],{})
    ...
    Fault Stq_u::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Stq_u::eaComp(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Stq_u::initiateAcc(AtomicSimpleCPU *xc,
                                      Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
// Store::sts([' Mem_ul = t_to_s(Fa_uq); '],{})
    ...
    Fault Sts::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Sts::eaComp(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Sts::initiateAcc(AtomicSimpleCPU *xc,
                                      Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
// Store::stt([' Mem_df = Fa; '],{})
    ...
    Fault Stt::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Stt::eaComp(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Stt::initiateAcc(AtomicSimpleCPU *xc,
                                      Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
// StoreCond::stl_c([' Mem_ul = Ra<31:0>; ', '\n                        uint64_t tmp = write_result;\n                        // see stq_c\n                        Ra = (tmp == 0 || tmp == 1) ? tmp : Ra;\n                        if (tmp == 1) {\n                            xc->setStCondFailures(0);\n                        }\n                    '],{'inst_flags': 'IsStoreConditional', 'mem_flags': 'LLSC'})
    ...
    Fault Stl_c::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Stl_c::eaComp(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
// StoreCond::stq_c([' Mem_uq = Ra; ', "\n                        uint64_t tmp = write_result;\n                        // If the write operation returns 0 or 1, then\n                        // this was a conventional store conditional,\n                        // and the value indicates the success/failure\n                        // of the operation.  If another value is\n                        // returned, then this was a Turbolaser\n                        // mailbox access, and we don't update the\n                        // result register at all.\n                        Ra = (tmp == 0 || tmp == 1) ? tmp : Ra;\n                        if (tmp == 1) {\n                            // clear failure counter... this is\n                            // non-architectural and for debugging\n                            // only.\n                            xc->setStCondFailures(0);\n                        }\n                    "],{'inst_flags': 'IsStoreConditional', 'mem_flags': 'LLSC'})
    ...
    Fault Stq_c::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Stq_c::eaComp(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Stq_c::initiateAcc(AtomicSimpleCPU *xc,
                                      Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
// IntegerOperate::addl([' Rc_sl = Ra_sl + Rb_or_imm_sl; '],{})
    ...
    Fault Addl::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault AddlImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::addlv(['\n                int32_t tmp  = Ra_sl + Rb_or_imm_sl;\n                // signed overflow occurs when operands have same sign\n                // and sign of result does not match.\n                if (Ra_sl<31:> == Rb_or_imm_sl<31:> && tmp<31:> != Ra_sl<31:>)\n                    fault = new IntegerOverflowFault;\n                Rc_sl = tmp;\n            '],{})
    ...
    Fault Addlv::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault AddlvImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::s4addl([' Rc_sl = (Ra_sl << 2) + Rb_or_imm_sl; '],{})
    ...
    Fault S4addl::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault S4addlImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::s8addl([' Rc_sl = (Ra_sl << 3) + Rb_or_imm_sl; '],{})
    ...
    Fault S8addl::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault S8addlImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::addq([' Rc = Ra + Rb_or_imm; '],{})
    ...
    Fault Addq::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault AddqImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::addqv(['\n                uint64_t tmp = Ra + Rb_or_imm;\n                // signed overflow occurs when operands have same sign\n                // and sign of result does not match.\n                if (Ra<63:> == Rb_or_imm<63:> && tmp<63:> != Ra<63:>)\n                    fault = new IntegerOverflowFault;\n                Rc = tmp;\n            '],{})
    ...
    Fault Addqv::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault AddqvImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::s4addq([' Rc = (Ra << 2) + Rb_or_imm; '],{})
    ...
    Fault S4addq::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault S4addqImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::s8addq([' Rc = (Ra << 3) + Rb_or_imm; '],{})
    ...
    Fault S8addq::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault S8addqImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::subl([' Rc_sl = Ra_sl - Rb_or_imm_sl; '],{})
    ...
    Fault Subl::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault SublImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::sublv(['\n                int32_t tmp  = Ra_sl - Rb_or_imm_sl;\n                // signed overflow detection is same as for add,\n                // except we need to look at the *complemented*\n                // sign bit of the subtrahend (Rb), i.e., if the initial\n                // signs are the *same* then no overflow can occur\n                if (Ra_sl<31:> != Rb_or_imm_sl<31:> && tmp<31:> != Ra_sl<31:>)\n                    fault = new IntegerOverflowFault;\n                Rc_sl = tmp;\n            '],{})
    ...
    Fault Sublv::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault SublvImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::s4subl([' Rc_sl = (Ra_sl << 2) - Rb_or_imm_sl; '],{})
    ...
    Fault S4subl::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault S4sublImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::s8subl([' Rc_sl = (Ra_sl << 3) - Rb_or_imm_sl; '],{})
    ...
    Fault S8subl::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault S8sublImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::subq([' Rc = Ra - Rb_or_imm; '],{})
    ...
    Fault Subq::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault SubqImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::subqv(['\n                uint64_t tmp  = Ra - Rb_or_imm;\n                // signed overflow detection is same as for add,\n                // except we need to look at the *complemented*\n                // sign bit of the subtrahend (Rb), i.e., if the initial\n                // signs are the *same* then no overflow can occur\n                if (Ra<63:> != Rb_or_imm<63:> && tmp<63:> != Ra<63:>)\n                    fault = new IntegerOverflowFault;\n                Rc = tmp;\n            '],{})
    ...
    Fault Subqv::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault SubqvImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::s4subq([' Rc = (Ra << 2) - Rb_or_imm; '],{})
    ...
    Fault S4subq::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault S4subqImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::s8subq([' Rc = (Ra << 3) - Rb_or_imm; '],{})
    ...
    Fault S8subq::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault S8subqImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::cmpeq([' Rc = (Ra == Rb_or_imm); '],{})
    ...
    Fault Cmpeq::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault CmpeqImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::cmple([' Rc = (Ra_sq <= Rb_or_imm_sq); '],{})
    ...
    Fault Cmple::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault CmpleImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::cmplt([' Rc = (Ra_sq <  Rb_or_imm_sq); '],{})
    ...
    Fault Cmplt::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault CmpltImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::cmpule([' Rc = (Ra_uq <= Rb_or_imm_uq); '],{})
    ...
    Fault Cmpule::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault CmpuleImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::cmpult([' Rc = (Ra_uq <  Rb_or_imm_uq); '],{})
    ...
    Fault Cmpult::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault CmpultImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::cmpbge(['\n                int hi = 7;\n                int lo = 0;\n                uint64_t tmp = 0;\n                for (int i = 0; i < 8; ++i) {\n                    tmp |= (Ra_uq<hi:lo> >= Rb_or_imm_uq<hi:lo>) << i;\n                    hi += 8;\n                    lo += 8;\n                }\n                Rc = tmp;\n            '],{})
    ...
    Fault Cmpbge::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault CmpbgeImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::and([' Rc = Ra & Rb_or_imm; '],{})
    ...
    Fault And::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault AndImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::bic([' Rc = Ra & ~Rb_or_imm; '],{})
    ...
    Fault Bic::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault BicImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::bis([' Rc = Ra | Rb_or_imm; '],{})
    ...
    Fault Bis::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault BisImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::ornot([' Rc = Ra | ~Rb_or_imm; '],{})
    ...
    Fault Ornot::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault OrnotImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::xor([' Rc = Ra ^ Rb_or_imm; '],{})
    ...
    Fault Xor::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault XorImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::eqv([' Rc = Ra ^ ~Rb_or_imm; '],{})
    ...
    Fault Eqv::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault EqvImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::cmovlbs([' Rc = ((Ra & 1) == 1) ? Rb_or_imm : Rc; '],{})
    ...
    Fault Cmovlbs::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault CmovlbsImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::cmovlbc([' Rc = ((Ra & 1) == 0) ? Rb_or_imm : Rc; '],{})
    ...
    Fault Cmovlbc::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault CmovlbcImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::cmoveq([' Rc = (Ra == 0) ? Rb_or_imm : Rc; '],{})
    ...
    Fault Cmoveq::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault CmoveqImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::cmovne([' Rc = (Ra != 0) ? Rb_or_imm : Rc; '],{})
    ...
    Fault Cmovne::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault CmovneImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::cmovlt([' Rc = (Ra_sq <  0) ? Rb_or_imm : Rc; '],{})
    ...
    Fault Cmovlt::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault CmovltImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::cmovge([' Rc = (Ra_sq >= 0) ? Rb_or_imm : Rc; '],{})
    ...
    Fault Cmovge::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault CmovgeImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::cmovle([' Rc = (Ra_sq <= 0) ? Rb_or_imm : Rc; '],{})
    ...
    Fault Cmovle::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault CmovleImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::cmovgt([' Rc = (Ra_sq >  0) ? Rb_or_imm : Rc; '],{})
    ...
    Fault Cmovgt::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault CmovgtImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::amask([' Rc = Rb_or_imm & ~ULL(0x17); '],{})
    ...
    Fault Amask::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault AmaskImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::implver([' Rc = FullSystem ? 1 : 2 '],{})
    ...
    Fault Implver::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::sll([' Rc = Ra << Rb_or_imm<5:0>; '],{})
    ...
    Fault Sll::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault SllImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::srl([' Rc = Ra_uq >> Rb_or_imm<5:0>; '],{})
    ...
    Fault Srl::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault SrlImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::sra([' Rc = Ra_sq >> Rb_or_imm<5:0>; '],{})
    ...
    Fault Sra::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault SraImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::mskbl([' Rc = Ra & ~(mask( 8) << (Rb_or_imm<2:0> * 8)); '],{})
    ...
    Fault Mskbl::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault MskblImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::mskwl([' Rc = Ra & ~(mask(16) << (Rb_or_imm<2:0> * 8)); '],{})
    ...
    Fault Mskwl::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault MskwlImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::mskll([' Rc = Ra & ~(mask(32) << (Rb_or_imm<2:0> * 8)); '],{})
    ...
    Fault Mskll::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault MskllImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::mskql([' Rc = Ra & ~(mask(64) << (Rb_or_imm<2:0> * 8)); '],{})
    ...
    Fault Mskql::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault MskqlImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::mskwh(['\n                int bv = Rb_or_imm<2:0>;\n                Rc =  bv ? (Ra & ~(mask(16) >> (64 - 8 * bv))) : Ra;\n            '],{})
    ...
    Fault Mskwh::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault MskwhImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::msklh(['\n                int bv = Rb_or_imm<2:0>;\n                Rc =  bv ? (Ra & ~(mask(32) >> (64 - 8 * bv))) : Ra;\n            '],{})
    ...
    Fault Msklh::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault MsklhImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::mskqh(['\n                int bv = Rb_or_imm<2:0>;\n                Rc =  bv ? (Ra & ~(mask(64) >> (64 - 8 * bv))) : Ra;\n            '],{})
    ...
    Fault Mskqh::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault MskqhImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::extbl([' Rc = (Ra_uq >> (Rb_or_imm<2:0> * 8))< 7:0>; '],{})
    ...
    Fault Extbl::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault ExtblImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::extwl([' Rc = (Ra_uq >> (Rb_or_imm<2:0> * 8))<15:0>; '],{})
    ...
    Fault Extwl::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault ExtwlImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::extll([' Rc = (Ra_uq >> (Rb_or_imm<2:0> * 8))<31:0>; '],{})
    ...
    Fault Extll::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault ExtllImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::extql([' Rc = (Ra_uq >> (Rb_or_imm<2:0> * 8)); '],{})
    ...
    Fault Extql::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault ExtqlImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::extwh(['\n                Rc = (Ra << (64 - (Rb_or_imm<2:0> * 8))<5:0>)<15:0>; '],{})
    ...
    Fault Extwh::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault ExtwhImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::extlh(['\n                Rc = (Ra << (64 - (Rb_or_imm<2:0> * 8))<5:0>)<31:0>; '],{})
    ...
    Fault Extlh::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault ExtlhImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::extqh(['\n                Rc = (Ra << (64 - (Rb_or_imm<2:0> * 8))<5:0>); '],{})
    ...
    Fault Extqh::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault ExtqhImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::insbl([' Rc = Ra< 7:0> << (Rb_or_imm<2:0> * 8); '],{})
    ...
    Fault Insbl::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault InsblImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::inswl([' Rc = Ra<15:0> << (Rb_or_imm<2:0> * 8); '],{})
    ...
    Fault Inswl::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault InswlImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::insll([' Rc = Ra<31:0> << (Rb_or_imm<2:0> * 8); '],{})
    ...
    Fault Insll::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault InsllImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::insql([' Rc = Ra       << (Rb_or_imm<2:0> * 8); '],{})
    ...
    Fault Insql::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault InsqlImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::inswh(['\n                int bv = Rb_or_imm<2:0>;\n                Rc = bv ? (Ra_uq<15:0> >> (64 - 8 * bv)) : 0;\n            '],{})
    ...
    Fault Inswh::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault InswhImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::inslh(['\n                int bv = Rb_or_imm<2:0>;\n                Rc = bv ? (Ra_uq<31:0> >> (64 - 8 * bv)) : 0;\n            '],{})
    ...
    Fault Inslh::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault InslhImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::insqh(['\n                int bv = Rb_or_imm<2:0>;\n                Rc = bv ? (Ra_uq       >> (64 - 8 * bv)) : 0;\n            '],{})
    ...
    Fault Insqh::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault InsqhImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::zap(['\n                uint64_t zapmask = 0;\n                for (int i = 0; i < 8; ++i) {\n                    if (Rb_or_imm<i:>)\n                        zapmask |= (mask(8) << (i * 8));\n                }\n                Rc = Ra & ~zapmask;\n            '],{})
    ...
    Fault Zap::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault ZapImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::zapnot(['\n                uint64_t zapmask = 0;\n                for (int i = 0; i < 8; ++i) {\n                    if (!Rb_or_imm<i:>)\n                        zapmask |= (mask(8) << (i * 8));\n                }\n                Rc = Ra & ~zapmask;\n            '],{})
    ...
    Fault Zapnot::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault ZapnotImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::mull([' Rc_sl = Ra_sl * Rb_or_imm_sl; ', 'IntMultOp'],{})
    ...
    Fault Mull::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault MullImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::mulq([' Rc    = Ra    * Rb_or_imm;    ', 'IntMultOp'],{})
    ...
    Fault Mulq::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault MulqImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::umulh(['\n                uint64_t hi, lo;\n                mul128(Ra, Rb_or_imm, hi, lo);\n                Rc = hi;\n            ', 'IntMultOp'],{})
    ...
    Fault Umulh::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault UmulhImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::mullv(['\n                // 32-bit multiply with trap on overflow\n                int64_t Rax = Ra_sl;    // sign extended version of Ra_sl\n                int64_t Rbx = Rb_or_imm_sl;\n                int64_t tmp = Rax * Rbx;\n                // To avoid overflow, all the upper 32 bits must match\n                // the sign bit of the lower 32.  We code this as\n                // checking the upper 33 bits for all 0s or all 1s.\n                uint64_t sign_bits = tmp<63:31>;\n                if (sign_bits != 0 && sign_bits != mask(33))\n                    fault = new IntegerOverflowFault;\n                Rc_sl = tmp<31:0>;\n            ', 'IntMultOp'],{})
    ...
    Fault Mullv::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault MullvImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::mulqv(['\n                // 64-bit multiply with trap on overflow\n                uint64_t hi, lo;\n                mul128(Ra, Rb_or_imm, hi, lo);\n                // all the upper 64 bits must match the sign bit of\n                // the lower 64\n                if (!((hi == 0 && lo<63:> == 0) ||\n                      (hi == mask(64) && lo<63:> == 1)))\n                    fault = new IntegerOverflowFault;\n                Rc = lo;\n            ', 'IntMultOp'],{})
    ...
    Fault Mulqv::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault MulqvImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::sextb([' Rc_sb = Rb_or_imm< 7:0>; '],{})
    ...
    Fault Sextb::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault SextbImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::sextw([' Rc_sw = Rb_or_imm<15:0>; '],{})
    ...
    Fault Sextw::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault SextwImm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::ctpop(['\n                             uint64_t count = 0;\n                             for (int i = 0; Rb<63:i>; ++i) {\n                                 if (Rb<i:i> == 0x1)\n                                     ++count;\n                             }\n                             Rc = count;\n                           ', 'IntAluOp'],{})
    ...
    Fault Ctpop::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::perr(['\n                             uint64_t temp = 0;\n                             int hi = 7;\n                             int lo = 0;\n                             for (int i = 0; i < 8; ++i) {\n                                 uint8_t ra_ub = Ra_uq<hi:lo>;\n                                 uint8_t rb_ub = Rb_uq<hi:lo>;\n                                 temp += (ra_ub >= rb_ub) ? \n                                         (ra_ub - rb_ub) : (rb_ub - ra_ub);\n                                 hi += 8;\n                                 lo += 8;\n                             }\n                             Rc = temp;\n                           '],{})
    ...
    Fault Perr::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::ctlz(['\n                             uint64_t count = 0;\n                             uint64_t temp = Rb;\n                             if (temp<63:32>) temp >>= 32; else count += 32;\n                             if (temp<31:16>) temp >>= 16; else count += 16;\n                             if (temp<15:8>) temp >>= 8; else count += 8;\n                             if (temp<7:4>) temp >>= 4; else count += 4;\n                             if (temp<3:2>) temp >>= 2; else count += 2;\n                             if (temp<1:1>) temp >>= 1; else count += 1;\n                             if ((temp<0:0>) != 0x1) count += 1;\n                             Rc = count;\n                           ', 'IntAluOp'],{})
    ...
    Fault Ctlz::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::cttz(['\n                             uint64_t count = 0;\n                             uint64_t temp = Rb;\n                             if (!(temp<31:0>)) { temp >>= 32; count += 32; }\n                             if (!(temp<15:0>)) { temp >>= 16; count += 16; }\n                             if (!(temp<7:0>)) { temp >>= 8; count += 8; }\n                             if (!(temp<3:0>)) { temp >>= 4; count += 4; }\n                             if (!(temp<1:0>)) { temp >>= 2; count += 2; }\n                             if (!(temp<0:0> & ULL(0x1))) { \n                                 temp >>= 1; count += 1; \n                             }\n                             if (!(temp<0:0> & ULL(0x1))) count += 1;\n                             Rc = count;\n                           ', 'IntAluOp'],{})
    ...
    Fault Cttz::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::unpkbw([' \n                             Rc = (Rb_uq<7:0>\n                                   | (Rb_uq<15:8> << 16)\n                                   | (Rb_uq<23:16> << 32)\n                                   | (Rb_uq<31:24> << 48));\n                           ', 'IntAluOp'],{})
    ...
    Fault Unpkbw::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::unpkbl(['\n                             Rc = (Rb_uq<7:0> | (Rb_uq<15:8> << 32));\n                           ', 'IntAluOp'],{})
    ...
    Fault Unpkbl::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::pkwb(['\n                             Rc = (Rb_uq<7:0>\n                                   | (Rb_uq<23:16> << 8)\n                                   | (Rb_uq<39:32> << 16)\n                                   | (Rb_uq<55:48> << 24));\n                           ', 'IntAluOp'],{})
    ...
    Fault Pkwb::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::pklb(['\n                             Rc = (Rb_uq<7:0> | (Rb_uq<39:32> << 8));\n                           ', 'IntAluOp'],{})
    ...
    Fault Pklb::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::minsb8(['\n                             uint64_t temp = 0;\n                             int hi = 63;\n                             int lo = 56;\n                             for (int i = 7; i >= 0; --i) {\n                                 int8_t ra_sb = Ra_uq<hi:lo>;\n                                 int8_t rb_sb = Rb_uq<hi:lo>;\n                                 temp = ((temp << 8) \n                                         | ((ra_sb < rb_sb) ? Ra_uq<hi:lo>\n                                                          : Rb_uq<hi:lo>));\n                                 hi -= 8;\n                                 lo -= 8;\n                             }\n                             Rc = temp;\n                          '],{})
    ...
    Fault Minsb8::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::minsw4(['\n                             uint64_t temp = 0;\n                             int hi = 63;\n                             int lo = 48;\n                             for (int i = 3; i >= 0; --i) {\n                                 int16_t ra_sw = Ra_uq<hi:lo>;\n                                 int16_t rb_sw = Rb_uq<hi:lo>;\n                                 temp = ((temp << 16) \n                                         | ((ra_sw < rb_sw) ? Ra_uq<hi:lo>\n                                                          : Rb_uq<hi:lo>));\n                                 hi -= 16;\n                                 lo -= 16;\n                             }\n                             Rc = temp;\n                          '],{})
    ...
    Fault Minsw4::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::minub8(['\n                             uint64_t temp = 0;\n                             int hi = 63;\n                             int lo = 56;\n                             for (int i = 7; i >= 0; --i) {\n                                 uint8_t ra_ub = Ra_uq<hi:lo>;\n                                 uint8_t rb_ub = Rb_uq<hi:lo>;\n                                 temp = ((temp << 8) \n                                         | ((ra_ub < rb_ub) ? Ra_uq<hi:lo>\n                                                          : Rb_uq<hi:lo>));\n                                 hi -= 8;\n                                 lo -= 8;\n                             }\n                             Rc = temp;\n                          '],{})
    ...
    Fault Minub8::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::minuw4(['\n                             uint64_t temp = 0;\n                             int hi = 63;\n                             int lo = 48;\n                             for (int i = 3; i >= 0; --i) {\n                                 uint16_t ra_sw = Ra_uq<hi:lo>;\n                                 uint16_t rb_sw = Rb_uq<hi:lo>;\n                                 temp = ((temp << 16) \n                                         | ((ra_sw < rb_sw) ? Ra_uq<hi:lo>\n                                                          : Rb_uq<hi:lo>));\n                                 hi -= 16;\n                                 lo -= 16;\n                             }\n                             Rc = temp;\n                          '],{})
    ...
    Fault Minuw4::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::maxub8(['\n                             uint64_t temp = 0;\n                             int hi = 63;\n                             int lo = 56;\n                             for (int i = 7; i >= 0; --i) {\n                                 uint8_t ra_ub = Ra_uq<hi:lo>;\n                                 uint8_t rb_ub = Rb_uq<hi:lo>;\n                                 temp = ((temp << 8) \n                                         | ((ra_ub > rb_ub) ? Ra_uq<hi:lo>\n                                                          : Rb_uq<hi:lo>));\n                                 hi -= 8;\n                                 lo -= 8;\n                             }\n                             Rc = temp;\n                          '],{})
    ...
    Fault Maxub8::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::maxuw4(['\n                             uint64_t temp = 0;\n                             int hi = 63;\n                             int lo = 48;\n                             for (int i = 3; i >= 0; --i) {\n                                 uint16_t ra_uw = Ra_uq<hi:lo>;\n                                 uint16_t rb_uw = Rb_uq<hi:lo>;\n                                 temp = ((temp << 16) \n                                         | ((ra_uw > rb_uw) ? Ra_uq<hi:lo>\n                                                          : Rb_uq<hi:lo>));\n                                 hi -= 16;\n                                 lo -= 16;\n                             }\n                             Rc = temp;\n                          '],{})
    ...
    Fault Maxuw4::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::maxsb8(['\n                             uint64_t temp = 0;\n                             int hi = 63;\n                             int lo = 56;\n                             for (int i = 7; i >= 0; --i) {\n                                 int8_t ra_sb = Ra_uq<hi:lo>;\n                                 int8_t rb_sb = Rb_uq<hi:lo>;\n                                 temp = ((temp << 8) \n                                         | ((ra_sb > rb_sb) ? Ra_uq<hi:lo>\n                                                          : Rb_uq<hi:lo>));\n                                 hi -= 8;\n                                 lo -= 8;\n                             }\n                             Rc = temp;\n                          '],{})
    ...
    Fault Maxsb8::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// IntegerOperate::maxsw4(['\n                             uint64_t temp = 0;\n                             int hi = 63;\n                             int lo = 48;\n                             for (int i = 3; i >= 0; --i) {\n                                 int16_t ra_sw = Ra_uq<hi:lo>;\n                                 int16_t rb_sw = Rb_uq<hi:lo>;\n                                 temp = ((temp << 16) \n                                         | ((ra_sw > rb_sw) ? Ra_uq<hi:lo>\n                                                          : Rb_uq<hi:lo>));\n                                 hi -= 16;\n                                 lo -= 16;\n                             }\n                             Rc = temp;\n                          '],{})
    ...
    Fault Maxsw4::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperateWithNopCheck::ftoit([' Rc = Fa_uq; ', 'FloatCvtOp'],{})
    ...
    Fault Ftoit::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperateWithNopCheck::ftois([' Rc_sl = t_to_s(Fa_uq); ', 'FloatCvtOp'],{})
    ...
    Fault Ftois::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// CondBranch::beq([' cond = (Ra == 0); '],{})
    ...
    Fault Beq::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// CondBranch::bne([' cond = (Ra != 0); '],{})
    ...
    Fault Bne::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// CondBranch::bge([' cond = (Ra_sq >= 0); '],{})
    ...
    Fault Bge::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// CondBranch::bgt([' cond = (Ra_sq >  0); '],{})
    ...
    Fault Bgt::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// CondBranch::ble([' cond = (Ra_sq <= 0); '],{})
    ...
    Fault Ble::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// CondBranch::blt([' cond = (Ra_sq < 0); '],{})
    ...
    Fault Blt::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// CondBranch::blbc([' cond = ((Ra & 1) == 0); '],{})
    ...
    Fault Blbc::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// CondBranch::blbs([' cond = ((Ra & 1) == 1); '],{})
    ...
    Fault Blbs::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// CondBranch::fbeq([' cond = (Fa == 0); '],{})
    ...
    Fault Fbeq::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// CondBranch::fbne([' cond = (Fa != 0); '],{})
    ...
    Fault Fbne::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// CondBranch::fbge([' cond = (Fa >= 0); '],{})
    ...
    Fault Fbge::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// CondBranch::fbgt([' cond = (Fa >  0); '],{})
    ...
    Fault Fbgt::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// CondBranch::fble([' cond = (Fa <= 0); '],{})
    ...
    Fault Fble::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// CondBranch::fblt([' cond = (Fa < 0); '],{})
    ...
    Fault Fblt::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// UncondBranch::br([],{})
    ...
    Fault Br::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault BrAndLink::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// UncondBranch::bsr(['IsCall'],{})
    ...
    Fault Bsr::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault BsrAndLink::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// Jump::jmp([],{})
    ...
    Fault Jmp::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault JmpAndLink::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// Jump::jsr(['IsCall'],{})
    ...
    Fault Jsr::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault JsrAndLink::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// Jump::ret(['IsReturn'],{})
    ...
    Fault Ret::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault RetAndLink::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// Jump::jsr_coroutine(['IsCall', 'IsReturn'],{})
    ...
    Fault Jsr_coroutine::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault Jsr_coroutineAndLink::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperateWithNopCheck::itofs([' Fc_uq = s_to_t(Ra_ul); ', 'FloatCvtOp'],{})
    ...
    Fault Itofs::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperateWithNopCheck::itoft([' Fc_uq = Ra_uq; ', 'FloatCvtOp'],{})
    ...
    Fault Itoft::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// FloatingPointOperate::sqrts(['\n                        if (Fb < 0.0)\n                            fault = new ArithmeticFault;\n                        Fc = sqrt(Fb);\n                    ', 'FloatSqrtOp'],{})
    ...
    Fault Sqrts::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
...
// FloatingPointOperate::sqrtt(['\n                        if (Fb < 0.0)\n                            fault = new ArithmeticFault;\n                        Fc = sqrt(Fb);\n                    ', 'FloatSqrtOp'],{})
    ...
    Fault Sqrtt::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        if (trappingMode != Imprecise && !warnedOnTrapping) {
            warn("%s: non-standard trapping mode not supported",
...
// FloatingPointOperate::adds([' Fc = Fa + Fb; '],{})
    ...
    Fault Adds::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        if (trappingMode != Imprecise && !warnedOnTrapping) {
            warn("%s: non-standard trapping mode not supported",
...
// FloatingPointOperate::subs([' Fc = Fa - Fb; '],{})
    ...
    Fault Subs::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        if (trappingMode != Imprecise && !warnedOnTrapping) {
            warn("%s: non-standard trapping mode not supported",
...
// FloatingPointOperate::muls([' Fc = Fa * Fb; ', 'FloatMultOp'],{})
    ...
    Fault Muls::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        if (trappingMode != Imprecise && !warnedOnTrapping) {
            warn("%s: non-standard trapping mode not supported",
...
// FloatingPointOperate::divs([' Fc = Fa / Fb; ', 'FloatDivOp'],{})
    ...
    Fault Divs::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        if (trappingMode != Imprecise && !warnedOnTrapping) {
            warn("%s: non-standard trapping mode not supported",
...
// FloatingPointOperate::addt([' Fc = Fa + Fb; '],{})
    ...
    Fault Addt::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        if (trappingMode != Imprecise && !warnedOnTrapping) {
            warn("%s: non-standard trapping mode not supported",
...
// FloatingPointOperate::subt([' Fc = Fa - Fb; '],{})
    ...
    Fault Subt::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        if (trappingMode != Imprecise && !warnedOnTrapping) {
            warn("%s: non-standard trapping mode not supported",
...
// FloatingPointOperate::mult([' Fc = Fa * Fb; ', 'FloatMultOp'],{})
    ...
    Fault Mult::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        if (trappingMode != Imprecise && !warnedOnTrapping) {
            warn("%s: non-standard trapping mode not supported",
...
// FloatingPointOperate::divt([' Fc = Fa / Fb; ', 'FloatDivOp'],{})
    ...
    Fault Divt::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        if (trappingMode != Imprecise && !warnedOnTrapping) {
            warn("%s: non-standard trapping mode not supported",
...
// BasicOperateWithNopCheck::cmpteq([' Fc = (Fa == Fb) ? 2.0 : 0.0; ', 'FloatCmpOp'],{})
    ...
    Fault Cmpteq::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperateWithNopCheck::cmptle([' Fc = (Fa <= Fb) ? 2.0 : 0.0; ', 'FloatCmpOp'],{})
    ...
    Fault Cmptle::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperateWithNopCheck::cmptlt([' Fc = (Fa <  Fb) ? 2.0 : 0.0; ', 'FloatCmpOp'],{})
    ...
    Fault Cmptlt::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperateWithNopCheck::cmptun([' // unordered\n                    Fc = (!(Fa < Fb) && !(Fa == Fb) && !(Fa > Fb)) ? 2.0 : 0.0;\n                ', 'FloatCmpOp'],{})
    ...
    Fault Cmptun::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// FPFixedRounding::cvttq([' Fc_sq = (int64_t)trunc(Fb); ', 'Chopped'],{})
    ...
    Fault CvttqChopped::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        if (trappingMode != Imprecise && !warnedOnTrapping) {
            warn("%s: non-standard trapping mode not supported",
...
// FPFixedRounding::cvttq([' Fc_sq = (int64_t)floor(Fb); ', 'MinusInfinity'],{})
    ...
    Fault CvttqMinusInfinity::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        if (trappingMode != Imprecise && !warnedOnTrapping) {
            warn("%s: non-standard trapping mode not supported",
...
// FloatingPointOperate::cvttq([' Fc_sq = (int64_t)nearbyint(Fb); '],{})
    ...
    Fault Cvttq::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        if (trappingMode != Imprecise && !warnedOnTrapping) {
            warn("%s: non-standard trapping mode not supported",
...
// BasicOperateWithNopCheck::cvtst([' Fc = Fb_sf; '],{})
    ...
    Fault Cvtst::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// FloatingPointOperate::cvtts([' Fc_sf = Fb; '],{})
    ...
    Fault Cvtts::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        if (trappingMode != Imprecise && !warnedOnTrapping) {
            warn("%s: non-standard trapping mode not supported",
...
// FloatingPointOperate::cvtqs([' Fc_sf = Fb_sq; '],{})
    ...
    Fault Cvtqs::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        if (trappingMode != Imprecise && !warnedOnTrapping) {
            warn("%s: non-standard trapping mode not supported",
...
// FloatingPointOperate::cvtqt([' Fc    = Fb_sq; '],{})
    ...
    Fault Cvtqt::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        if (trappingMode != Imprecise && !warnedOnTrapping) {
            warn("%s: non-standard trapping mode not supported",
...
// BasicOperateWithNopCheck::cvtlq(['\n                Fc_sl = (Fb_uq<63:62> << 30) | Fb_uq<58:29>;\n            '],{})
    ...
    Fault Cvtlq::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperateWithNopCheck::cvtql(['\n                Fc_uq = (Fb_uq<31:30> << 62) | (Fb_uq<29:0> << 29);\n            '],{})
    ...
    Fault Cvtql::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperateWithNopCheck::cvtqlv(['\n                // To avoid overflow, all the upper 32 bits must match\n                // the sign bit of the lower 32.  We code this as\n                // checking the upper 33 bits for all 0s or all 1s.\n                uint64_t sign_bits = Fb_uq<63:31>;\n                if (sign_bits != 0 && sign_bits != mask(33))\n                    fault = new IntegerOverflowFault;\n                Fc_uq = (Fb_uq<31:30> << 62) | (Fb_uq<29:0> << 29);\n            '],{})
    ...
    Fault Cvtqlv::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperateWithNopCheck::cpys(['  // copy sign\n                Fc_uq = (Fa_uq<63:> << 63) | Fb_uq<62:0>;\n            '],{})
    ...
    Fault Cpys::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperateWithNopCheck::cpysn([' // copy sign negated\n                Fc_uq = (~Fa_uq<63:> << 63) | Fb_uq<62:0>;\n            '],{})
    ...
    Fault Cpysn::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperateWithNopCheck::cpyse([' // copy sign and exponent\n                Fc_uq = (Fa_uq<63:52> << 52) | Fb_uq<51:0>;\n            '],{})
    ...
    Fault Cpyse::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperateWithNopCheck::fcmoveq([' Fc = (Fa == 0) ? Fb : Fc; '],{})
    ...
    Fault Fcmoveq::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperateWithNopCheck::fcmovne([' Fc = (Fa != 0) ? Fb : Fc; '],{})
    ...
    Fault Fcmovne::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperateWithNopCheck::fcmovlt([' Fc = (Fa <  0) ? Fb : Fc; '],{})
    ...
    Fault Fcmovlt::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperateWithNopCheck::fcmovge([' Fc = (Fa >= 0) ? Fb : Fc; '],{})
    ...
    Fault Fcmovge::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperateWithNopCheck::fcmovle([' Fc = (Fa <= 0) ? Fb : Fc; '],{})
    ...
    Fault Fcmovle::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperateWithNopCheck::fcmovgt([' Fc = (Fa >  0) ? Fb : Fc; '],{})
    ...
    Fault Fcmovgt::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperateWithNopCheck::mt_fpcr([' FPCR = Fa_uq; ', 'IsIprAccess'],{})
    ...
    Fault Mt_fpcr::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperateWithNopCheck::mf_fpcr([' Fa_uq = FPCR; ', 'IsIprAccess'],{})
    ...
    Fault Mf_fpcr::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// MiscPrefetch::wh64([' EA = Rb & ~ULL(63); ', ' ; '],{'mem_flags': 'PREFETCH'})
    ...
    Fault Wh64::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA M5_VAR_USED;
        Fault fault = NoFault;
...
;
    ...
    Fault Wh64::eaComp(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Wh64::initiateAcc(AtomicSimpleCPU *xc,
                                      Trace::InstRecord *traceData) const
    {
        warn("initiateAcc undefined: Misc instruction does not support split "
             "access method!");
...
// BasicOperate::rpcc(['\n                /* Rb is a fake dependency so here is a fun way to get\n                 * the parser to understand that.\n                 */\n                uint64_t unused_var M5_VAR_USED = Rb;\n                Ra = FullSystem ? xc->readMiscReg(IPR_CC) : curTick();\n            ', 'IsUnverifiable'],{})
    ...
    Fault Rpcc::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::trapb([' ', 'IsSerializing', 'IsSerializeBefore', 'No_OpClass'],{})
    ...
    Fault Trapb::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::excb([' ', 'IsSerializing', 'IsSerializeBefore', 'No_OpClass'],{})
    ...
    Fault Excb::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::mb([' ', 'IsMemBarrier', 'MemReadOp'],{})
    ...
    Fault Mb::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::wmb([' ', 'IsWriteBarrier', 'MemWriteOp'],{})
    ...
    Fault Wmb::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::rc((['\n                Ra = IntrFlag;\n                IntrFlag = 0;\n            ', 'IsNonSpeculative', 'IsUnverifiable'], {}))
    ...
    Fault Rc::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::rs((['\n                Ra = IntrFlag;\n                IntrFlag = 1;\n            ', 'IsNonSpeculative', 'IsUnverifiable'], {}))
    ...
    Fault Rs::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// EmulatedCallPal::halt(['\n                    exitSimLoop("halt instruction encountered");\n                ', 'IsNonSpeculative'],{})
    ...
    Fault Halt::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// EmulatedCallPal::callsys(['\n                    xc->syscall(R0);\n                ', 'IsSerializeAfter', 'IsNonSpeculative', 'IsSyscall'],{})
    ...
    Fault Callsys::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// EmulatedCallPal::rduniq([' R0 = Runiq; ', 'IsIprAccess'],{})
    ...
    Fault Rduniq::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// EmulatedCallPal::wruniq([' Runiq = R16; ', 'IsIprAccess'],{})
    ...
    Fault Wruniq::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// CallPal::call_pal((['\n            if (!palValid ||\n                (palPriv\n                 && xc->readMiscReg(IPR_ICM) != mode_kernel)) {\n                // invalid pal function code, or attempt to do privileged\n                // PAL call in non-kernel mode\n                fault = new UnimplementedOpcodeFault;\n            } else {\n                // check to see if simulator wants to do something special\n                // on this PAL call (including maybe suppress it)\n                bool dopal = xc->simPalCheck(palFunc);\n\n                if (dopal) {\n                    xc->setMiscReg(IPR_EXC_ADDR, NPC);\n                    NPC = xc->readMiscReg(IPR_PAL_BASE) + palOffset;\n                }\n            }\n        ', 'IsNonSpeculative'], {}))
    ...
    Fault Call_pal::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// HwLoad::hw_ld([' EA = (Rb + disp) & ~3; ', ' Ra = Mem_ul; ', 'L', 'IsSerializing', 'IsSerializeBefore'],{})
    ...
    Fault Hw_ldL::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Hw_ldL::eaComp(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Hw_ldL::initiateAcc(AtomicSimpleCPU *xc,
                                      Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
// HwLoad::hw_ld([' EA = (Rb + disp) & ~7; ', ' Ra = Mem_uq; ', 'Q', 'IsSerializing', 'IsSerializeBefore'],{})
    ...
    Fault Hw_ldQ::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Hw_ldQ::eaComp(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Hw_ldQ::initiateAcc(AtomicSimpleCPU *xc,
                                      Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
// HwStore::hw_st([' EA = (Rb + disp) & ~3; ', ' Mem_ul = Ra<31:0>; ', 'L', 'IsSerializing', 'IsSerializeBefore'],{})
    ...
    Fault Hw_stL::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Hw_stL::eaComp(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Hw_stL::initiateAcc(AtomicSimpleCPU *xc,
                                      Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
// HwStore::hw_st([' EA = (Rb + disp) & ~7; ', ' Mem_uq = Ra_uq; ', 'Q', 'IsSerializing', 'IsSerializeBefore'],{})
    ...
    Fault Hw_stQ::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Hw_stQ::eaComp(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
;
    ...
    Fault Hw_stQ::initiateAcc(AtomicSimpleCPU *xc,
                                      Trace::InstRecord *traceData) const
    {
        Addr EA;
        Fault fault = NoFault;
...
// HwMoveIPR::hw_mfpr(['\n                int miscRegIndex = (ipr_index < MaxInternalProcRegs) ?\n                        IprToMiscRegIndex[ipr_index] : -1;\n                if(miscRegIndex < 0 || !IprIsReadable(miscRegIndex) ||\n                    miscRegIndex >= NumInternalProcRegs)\n                        fault = new UnimplementedOpcodeFault;\n                else\n                    Ra = xc->readMiscReg(miscRegIndex);\n            ', 'IsIprAccess'],{})
    ...
    Fault Hw_mfpr::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// HwMoveIPR::hw_mtpr(['\n                int miscRegIndex = (ipr_index < MaxInternalProcRegs) ?\n                        IprToMiscRegIndex[ipr_index] : -1;\n                if(miscRegIndex < 0 || !IprIsWritable(miscRegIndex) ||\n                    miscRegIndex >= NumInternalProcRegs)\n                        fault = new UnimplementedOpcodeFault;\n                else\n                    xc->setMiscReg(miscRegIndex, Ra);\n                if (traceData) { traceData->setData(Ra); }\n            ', 'IsIprAccess'],{})
    ...
    Fault Hw_mtpr::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::hw_rei([' xc->hwrei(); ', 'IsSerializing', 'IsSerializeBefore'],{})
    ...
    Fault Hw_rei::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::arm(['\n                PseudoInst::arm(xc->tcBase());\n            ', 'IsNonSpeculative'],{})
    ...
    Fault Arm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::quiesce(["\n                // Don't sleep if (unmasked) interrupts are pending\n                Interrupts* interrupts =\n                    xc->tcBase()->getCpuPtr()->getInterruptController();\n                if (interrupts->checkInterrupts(xc->tcBase())) {\n                    PseudoInst::quiesceSkip(xc->tcBase());\n                } else {\n                    PseudoInst::quiesce(xc->tcBase());\n                }\n            ", 'IsNonSpeculative', 'IsQuiesce'],{})
    ...
    Fault Quiesce::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::quiesceNs(['\n                PseudoInst::quiesceNs(xc->tcBase(), R16);\n            ', 'IsNonSpeculative', 'IsQuiesce'],{})
    ...
    Fault QuiesceNs::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::quiesceCycles(['\n                PseudoInst::quiesceCycles(xc->tcBase(), R16);\n            ', 'IsNonSpeculative', 'IsQuiesce', 'IsUnverifiable'],{})
    ...
    Fault QuiesceCycles::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::quiesceTime(['\n                R0 = PseudoInst::quiesceTime(xc->tcBase());\n            ', 'IsNonSpeculative', 'IsUnverifiable'],{})
    ...
    Fault QuiesceTime::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::rpns(['\n                R0 = PseudoInst::rpns(xc->tcBase());\n            ', 'IsNonSpeculative', 'IsUnverifiable'],{})
    ...
    Fault Rpns::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::wakeCPU(['\n                PseudoInst::wakeCPU(xc->tcBase(), R16);\n            ', 'IsNonSpeculative', 'IsUnverifiable'],{})
    ...
    Fault WakeCPU::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::deprecated_ivlb(['\n                warn_once("Obsolete M5 ivlb instruction encountered.\\n");\n            '],{})
    ...
    Fault Deprecated_ivlb::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::deprecated_ivle(['\n                warn_once("Obsolete M5 ivlb instruction encountered.\\n");\n            '],{})
    ...
    Fault Deprecated_ivle::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::deprecated_exit(['\n                warn_once("deprecated M5 exit instruction encountered.\\n");\n                PseudoInst::m5exit(xc->tcBase(), 0);\n            ', 'No_OpClass', 'IsNonSpeculative'],{})
    ...
    Fault Deprecated_exit::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::m5exit(['\n                PseudoInst::m5exit(xc->tcBase(), R16);\n            ', 'No_OpClass', 'IsNonSpeculative'],{})
    ...
    Fault M5exit::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::loadsymbol(['\n                PseudoInst::loadsymbol(xc->tcBase());\n            ', 'No_OpClass', 'IsNonSpeculative'],{})
    ...
    Fault Loadsymbol::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::initparam(['\n                Ra = PseudoInst::initParam(xc->tcBase());\n            '],{})
    ...
    Fault Initparam::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::resetstats(['\n                PseudoInst::resetstats(xc->tcBase(), R16, R17);\n            ', 'IsNonSpeculative'],{})
    ...
    Fault Resetstats::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::dumpstats(['\n                PseudoInst::dumpstats(xc->tcBase(), R16, R17);\n            ', 'IsNonSpeculative'],{})
    ...
    Fault Dumpstats::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::dumpresetstats(['\n                PseudoInst::dumpresetstats(xc->tcBase(), R16, R17);\n            ', 'IsNonSpeculative'],{})
    ...
    Fault Dumpresetstats::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::m5checkpoint(['\n                PseudoInst::m5checkpoint(xc->tcBase(), R16, R17);\n            ', 'IsNonSpeculative'],{})
    ...
    Fault M5checkpoint::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::m5readfile(['\n                R0 = PseudoInst::readfile(xc->tcBase(), R16, R17, R18);\n            ', 'IsNonSpeculative'],{})
    ...
    Fault M5readfile::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::m5break(['\n                PseudoInst::debugbreak(xc->tcBase());\n            ', 'IsNonSpeculative'],{})
    ...
    Fault M5break::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::m5switchcpu(['\n                PseudoInst::switchcpu(xc->tcBase());\n            ', 'IsNonSpeculative'],{})
    ...
    Fault M5switchcpu::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::m5addsymbol(['\n                PseudoInst::addsymbol(xc->tcBase(), R16, R17);\n            ', 'IsNonSpeculative'],{})
    ...
    Fault M5addsymbol::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::m5panic(['\n                panic("M5 panic instruction called at pc = %#x.", PC);\n            ', 'IsNonSpeculative'],{})
    ...
    Fault M5panic::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::m5a_old(['\n                    panic("Deprecated M5 annotate instruction executed "\n                          "at pc = %#x\\n", PC);\n                ', 'IsNonSpeculative'],{})
    ...
    Fault M5a_old::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::m5a_bsm(['\n                    CPANN(swSmBegin);\n                ', 'IsNonSpeculative'],{})
    ...
    Fault M5a_bsm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::m5a_esm(['\n                    CPANN(swSmEnd);\n                ', 'IsNonSpeculative'],{})
    ...
    Fault M5a_esm::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::m5a_begin(['\n                    CPANN(swExplictBegin);\n                ', 'IsNonSpeculative'],{})
    ...
    Fault M5a_begin::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::m5a_end(['\n                    CPANN(swEnd);\n                ', 'IsNonSpeculative'],{})
    ...
    Fault M5a_end::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::m5a_q(['\n                    CPANN(swQ);\n                ', 'IsNonSpeculative'],{})
    ...
    Fault M5a_q::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::m5a_dq(['\n                    CPANN(swDq);\n                ', 'IsNonSpeculative'],{})
    ...
    Fault M5a_dq::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::m5a_wf(['\n                    CPANN(swWf);\n                ', 'IsNonSpeculative'],{})
    ...
    Fault M5a_wf::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::m5a_we(['\n                    CPANN(swWe);\n                ', 'IsNonSpeculative'],{})
    ...
    Fault M5a_we::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::m5a_sq(['\n                    CPANN(swSq);\n                ', 'IsNonSpeculative'],{})
    ...
    Fault M5a_sq::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::m5a_aq(['\n                    CPANN(swAq);\n                ', 'IsNonSpeculative'],{})
    ...
    Fault M5a_aq::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::m5a_pq(['\n                    CPANN(swPq);\n                ', 'IsNonSpeculative'],{})
    ...
    Fault M5a_pq::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::m5a_l(['\n                    CPANN(swLink);\n                ', 'IsNonSpeculative'],{})
    ...
    Fault M5a_l::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::m5a_identify(['\n                    CPANN(swIdentify);\n                ', 'IsNonSpeculative'],{})
    ...
    Fault M5a_identify::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::m5a_getid(['\n                    R0 = CPANN(swGetId);\n                ', 'IsNonSpeculative'],{})
    ...
    Fault M5a_getid::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::m5a_scl(['\n                    CPANN(swSyscallLink);\n                ', 'IsNonSpeculative'],{})
    ...
    Fault M5a_scl::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::m5a_rq(['\n                    CPANN(swRq);\n                ', 'IsNonSpeculative'],{})
    ...
    Fault M5a_rq::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::m5reserved2(['\n                warn("M5 reserved opcode ignored");\n            ', 'IsNonSpeculative'],{})
    ...
    Fault M5reserved2::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::m5reserved3(['\n                warn("M5 reserved opcode ignored");\n            ', 'IsNonSpeculative'],{})
    ...
    Fault M5reserved3::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::m5reserved4(['\n                warn("M5 reserved opcode ignored");\n            ', 'IsNonSpeculative'],{})
    ...
    Fault M5reserved4::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
// BasicOperate::m5reserved5(['\n                warn("M5 reserved opcode ignored");\n            ', 'IsNonSpeculative'],{})
    ...
    Fault M5reserved5::execute(AtomicSimpleCPU *xc,
                                  Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;

// Auto generated C++ code started by /Users/hokeunkim/Development/EE219D/gem5/src/mem/slicc/symbols/StateMachine.py:1151
                                        ...
                                        const Address& addr)
{
  ...
  case HASH_FUN(Directory_State_ID, Directory_Event_Memory_Data):
    ...
    if (!(*m_Directory_dmaResponseFromDir_ptr).areNSlotsAvailable(1))
        return TransitionResult_ResourceStall;

 ...
 *
 * Auto generated C++ code started by /Users/hokeunkim/Development/EE219D/gem5/src/mem/slicc/symbols/StateMachine.py:421
    ...
    : AbstractController(p)
{
    ...
    m_L1Cache_mandatoryQueue_ptr->setReceiver(this);
    if (p->peer != NULL)
...
L1Cache_Controller::init()
{
    ...
    m_L1Cache_requestFromCache_ptr->setSender(this);
    ...
    m_L1Cache_responseFromCache_ptr->setSender(this);
    ...
    m_L1Cache_forwardToCache_ptr->setReceiver(this);
    ...
    m_L1Cache_responseToCache_ptr->setReceiver(this);
...
L1Cache_Controller::regStats()
{
    if (m_version == 0) {
        for (L1Cache_Event event = L1Cache_Event_FIRST;
            ...
            t->name(name() + "." + L1Cache_Event_to_string(event));
        ...
        for (L1Cache_State state = L1Cache_State_FIRST;
            ...
            for (L1Cache_Event event = L1Cache_Event_FIRST;
                ...
                Stats::Vector *t = new Stats::Vector();
                t->init(m_num_controllers);
                t->name(name() + "." + L1Cache_State_to_string(state) +
...
L1Cache_Controller::b_issuePUT(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, const Address& addr)
{
    ...
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MI_example-cache.sm:263: %s.\n", "assert failure");
    ...
    assert(in_msg_ptr != NULL); // Check the cast result
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MI_example-cache.sm:276: %s.\n", "assert failure");
    ...
    assert(in_msg_ptr != NULL); // Check the cast result
{
    ...
    #ifndef NDEBUG
    if (!((m_tbe_ptr != NULL))) {
        panic("Runtime Error at MI_example-cache.sm:290: %s.\n", "assert failure");
...
L1Cache_Controller::r_load_hit(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, const Address& addr)
{
    ...
    #ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MI_example-cache.sm:336: %s.\n", "assert failure");

}
#endif
;
DPRINTF(RubySlicc, "MI_example-cache.sm:337: %s\n", (*m_cache_entry_ptr).m_DataBlk);
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MI_example-cache.sm:343: %s.\n", "assert failure");

}
#endif
;
DPRINTF(RubySlicc, "MI_example-cache.sm:344: %s\n", (*m_cache_entry_ptr).m_DataBlk);
...
L1Cache_Controller::s_store_hit(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, const Address& addr)
{
    ...
    #ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MI_example-cache.sm:351: %s.\n", "assert failure");

}
#endif
;
DPRINTF(RubySlicc, "MI_example-cache.sm:352: %s\n", (*m_cache_entry_ptr).m_DataBlk);
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MI_example-cache.sm:367: %s.\n", "assert failure");
...
L1Cache_Controller::forward_eviction_to_cpu(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, const Address& addr)
{
    DPRINTF(RubyGenerated, "executing forward_eviction_to_cpu\n");
        if (m_send_evictions) {
        DPRINTF(RubySlicc, "MI_example-cache.sm:374: Sending invalidation for %s to the CPU\n", addr);
...
L1Cache_Controller::x_copyDataFromCacheToTBE(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, const Address& addr)
{
    ...
    #ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MI_example-cache.sm:390: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at MI_example-cache.sm:391: %s.\n", "assert failure");
            ...
            if ((param_type == RubyRequestType_IFETCH)) {
                return L1Cache_Event_Ifetch;
                    ...
                    if (((param_type == RubyRequestType_ST) || (param_type == RubyRequestType_ATOMIC))) {
                        ...
                        panic("Runtime Error at MI_example-cache.sm:123: %s.\n", ("Invalid RubyRequestType"));
                        ;
                    }
                }
            }
...
{
if (m_L1Cache_requestFromCache_ptr->functionalRead(pkt)) { return true; }
if (m_L1Cache_responseFromCache_ptr->functionalRead(pkt)) { return true; }
if (m_L1Cache_forwardToCache_ptr->functionalRead(pkt)) { return true; }
if (m_L1Cache_responseToCache_ptr->functionalRead(pkt)) { return true; }
if (m_L1Cache_mandatoryQueue_ptr->functionalRead(pkt)) { return true; }
                return false;
}
uint32_t
...
num_functional_writes += m_L1Cache_requestFromCache_ptr->functionalWrite(pkt);
num_functional_writes += m_L1Cache_responseFromCache_ptr->functionalWrite(pkt);
num_functional_writes += m_L1Cache_forwardToCache_ptr->functionalWrite(pkt);
num_functional_writes += m_L1Cache_responseToCache_ptr->functionalWrite(pkt);
num_functional_writes += m_L1Cache_mandatoryQueue_ptr->functionalWrite(pkt);

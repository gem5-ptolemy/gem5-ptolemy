...
class TaggedPrefetcher(m5.internal.param_BasePrefetcher.BasePrefetcher):
...
class TaggedPrefetcherParams(m5.internal.param_BasePrefetcher.BasePrefetcherParams):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr

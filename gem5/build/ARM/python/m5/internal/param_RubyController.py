...
class AbstractController(m5.internal.param_ClockedObject.ClockedObject):
...
class RubyControllerParams(m5.internal.param_ClockedObject.ClockedObjectParams):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    cntrl_id = _swig_property(_param_RubyController.RubyControllerParams_cntrl_id_get, _param_RubyController.RubyControllerParams_cntrl_id_set)
    ...
    peer = _swig_property(_param_RubyController.RubyControllerParams_peer_get, _param_RubyController.RubyControllerParams_peer_set)
